...
export const projects: Project[] = [
  ...
  {
    slug: "photowala-bayad",
    title: "PhotoWala Bayad",
    tagline: "Photography studio website",
    description:
      "Photography studio website for PHOTOWALA BAYAD — weddings, portraits, events & street photography from Bayad, Gujarat.",
    tags: ["Next.js 16", "TypeScript", "Tailwind CSS", "shadcn/ui", "Framer Motion", "Prisma"],
    liveUrl: "https://photowala-bayad.vercel.app",
    repoUrl: "https://github.com/kashyap-p/photowala-bayad",
    accent: "teal",
    highlights: [
